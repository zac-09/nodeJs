      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') location.reload(true); // console.log("hello from logout")
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiemFjLTA5IiwiYSI6ImNrOTJhMmZodDAwZXEzbm51cW5nM3FrNnAifQ.MUZBtaSdtj13L7LuaFfF-A';
...
var stripe = Stripe('pk_test_ZYdnEcSNEInn0dbYo0UsgJqX00Wq65T5uy');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session.data); //create checkout form 
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // console.log(name,email)

    (0, _updateSettings.update)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.update)({
...
},{}]},{},["C:/Users/PANDRAH/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
